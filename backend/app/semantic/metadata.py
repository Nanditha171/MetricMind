...
METRICS_DICTIONARY: Dict[str, Dict[str, Any]] = {
    ...
    "margin_pct": {
        ...
        "sql_formula": "CASE WHEN SUM(f.revenue) > 0 THEN ROUND(SUM(f.profit) * 100.0 / SUM(f.revenue), 2) ELSE 0.0 END",
        "unit": "percent",
        "format": "percentage",
    ...
    "material_cost": {
        ...
        "sql_formula": "SUM(ROUND(f.cost * 0.75, 2))",
        "unit": "USD",
        "format": "currency",
    ...
    "shipping_cost": {
        ...
        "sql_formula": "SUM(ROUND(f.cost * 0.25, 2))",
        "unit": "USD",
        "format": "currency",
